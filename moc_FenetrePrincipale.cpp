...
#include <memory>
#include "include/interface/FenetrePrincipale.hpp"
...
QT_MOC_LITERAL(4, 41, 14), // "calculate_dist"
QT_MOC_LITERAL(5, 56, 18), // "convert_deg_to_dms"
QT_MOC_LITERAL(6, 75, 3), // "deg"
QT_MOC_LITERAL(7, 79, 6) // "is_lat"

    },
    "FenetrePrincipale\0affiche_pos_scene\0"
    "\0pos\0calculate_dist\0convert_deg_to_dms\0"
    "deg\0is_lat"
};
...
static const uint qt_meta_data_FenetrePrincipale[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::QString, QMetaType::QReal, QMetaType::Bool,    6,    7,
...
void FenetrePrincipale::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->calculate_dist(); break;
        case 2: { QString _r = _t->convert_deg_to_dms((*reinterpret_cast< qreal(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])));
