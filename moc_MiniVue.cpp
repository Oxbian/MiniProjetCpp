/****************************************************************************
** Meta object code from reading C++ file 'MiniVue.hpp'
**
...
#include <memory>
#include "include/interface/MiniVue.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MiniVue.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 13), // "draw_viewport"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11) // "zoomed_zone"

    },
    "MiniVue\0draw_viewport\0\0zoomed_zone"
};
...
void MiniVue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->draw_viewport((*reinterpret_cast< QRectF(*)>(_a[1]))); break;
        default: ;
        }
    }
}
